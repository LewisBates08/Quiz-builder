...
def setup_styles():
    """Define every ttk.Button style used across the app. Called once, globally,
    before any widgets are created. 'clam' is used because it actually respects
    custom background/foreground colors — the default 'aqua' theme on macOS
    ignores them for tk.Button, which is why buttons were unstyled before."""
    style = ttk.Style()
    style.theme_use('clam')

    # Sidebar nav buttons + hamburger toggle buttons (Dashboard/Review headers)
    style.configure(
        "Sidebar.TButton",
...
class controller():
    def __init__(self, root):
        setup_styles()  # must run before any ttk.Button is created
        self.root = root
...
class Login(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.login_button = ttk.Button(
            self.main_content, text="Login", style="Accent.TButton",
...
class Dashboard(tk.Frame):
    ...
    def create_subframes(self):
        ...
        self.sidebar_button = ttk.Button(
            self.header, text="☰", style="Sidebar.TButton",
...
class Quiz(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.previous_button = ttk.Button(self.stats, text="Previous", style="QuizNav.TButton")
        self.previous_button.grid(row=0, column=3, sticky='w')
        self.next_button = ttk.Button(self.stats, text="Next", style="QuizNav.TButton")
        ...
        self.submit_button = ttk.Button(
            self.main_content, text="Submit", style="QuizSubmit.TButton",
...
class Review(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.previous_button = ttk.Button(self.stats, text="Previous", style="ReviewNav.TButton", width=10)
        self.previous_button.grid(row=0, column=9, sticky='e')
        self.next_button = ttk.Button(self.stats, text="Next", style="ReviewNav.TButton", width=10)
